...
function App() {
    ...
    function updateItem(e) {
        let cloneList = [...list]
        const indexToUpdate = cloneList.findIndex(item => item.ref=== Number(e.target.dataset.id))

        cloneList[indexToUpdate].status = !cloneList[indexToUpdate].status

        setList(cloneList)
        UpdateDataInStorage(e.target.dataset.id, cloneList[indexToUpdate].status)
    }
                            ...
                            <li className="item" key={item.ref} onTouchMove={() => deleteItem(item.ref)}>
                                ...
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-content">
                                        <a href="#" className="dropdown-item" data-id={item.ref} onClick={() => deleteItem(item.ref)}>
